...
class Ui_Widget(object):
    def setupUi(self, Widget):
        ...
        icon = QIcon()
        icon.addFile(
            "logos/better_logo.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off
        )
        ...
        self.telemetryTab.setObjectName("telemetryTab")
        ...
        self.controlLayout.setSizeConstraint(
        ...
        self.logoLabel.setPixmap(QPixmap(":/images/logo"))
        ...
        self.udpIpAddressLabel.setObjectName("udpIpAddressLabel")

        self.addressLayout.addWidget(self.udpIpAddressLabel)

        self.udpIpAddressInput = QLineEdit(self.telemetryTab)
        self.udpIpAddressInput.setObjectName("udpIpAddressInput")
        self.udpIpAddressInput.setStyleSheet("")
        ...
        self.udpPortLabel.setObjectName("udpPortLabel")
        ...
        self.udpPortInput.setObjectName("udpPortInput")
        self.udpPortInput.setStyleSheet("")
        ...
        self.interfaceAddressLabel.setObjectName("interfaceAddressLabel")

        self.interfaceLayout.addWidget(self.interfaceAddressLabel)

        self.interfaceAddressInput = QLineEdit(self.telemetryTab)
        self.interfaceAddressInput.setObjectName("interfaceAddressInput")

        self.interfaceLayout.addWidget(self.interfaceAddressInput)

        self.connectionLayout.addLayout(self.interfaceLayout)

        self.udpConnectButton = QPushButton(self.telemetryTab)
        self.udpConnectButton.setObjectName("udpConnectButton")
        self.udpConnectButton.setMaximumSize(QSize(1000, 16777215))
        self.udpConnectButton.setStyleSheet("")
        ...
        self.valveStatusLayout.setObjectName("valveStatusLayout")
        self.gridLayout_2 = QGridLayout()
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.xv5 = QLabel(self.telemetryTab)
        self.xv5.setObjectName("xv5")
        font = QFont()
        ...
        self.xv8State.setObjectName("xv8State")
        ...
        self.quickDisconnect.setObjectName("quickDisconnect")
        ...
        self.xv4State.setObjectName("xv4State")
        ...
        self.cv1State.setObjectName("cv1State")
        ...
        sizePolicy1.setHeightForWidth(
            self.pressurePlot.sizePolicy().hasHeightForWidth()
        )
        ...
        self.pAndIdTab.setObjectName("pAndIdTab")
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(
            QCoreApplication.translate("Widget", "Hybrid Engine Ground System UI", None)
        )
        self.logoLabel.setText("")
        # if QT_CONFIG(tooltip)
        self.udpIpAddressLabel.setToolTip(
            QCoreApplication.translate("Widget", "Address of multicast group", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.udpIpAddressLabel.setText(
            QCoreApplication.translate("Widget", "MCast IPv4 address*: ", None)
        )
        # if QT_CONFIG(tooltip)
        self.udpPortLabel.setToolTip(
            QCoreApplication.translate("Widget", "Port of multicast group", None)
        )
        # endif // QT_CONFIG(tooltip)
        self.udpPortLabel.setText(
            QCoreApplication.translate("Widget", "MCast port*: ", None)
        )
        # if QT_CONFIG(tooltip)
        self.interfaceAddressLabel.setToolTip(
            QCoreApplication.translate(
                "Widget", "Enter ipconfig in terminal to see interfaces", None
            )
        )
        # endif // QT_CONFIG(tooltip)
        self.interfaceAddressLabel.setText(
            QCoreApplication.translate("Widget", "Interface address:", None)
        )
        self.udpConnectButton.setText(
            QCoreApplication.translate("Widget", "Create UDP connection", None)
        )
        self.xv5.setText(QCoreApplication.translate("Widget", "XV-5", None))
        self.xv8State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.quickDisconnect.setText(
            QCoreApplication.translate(
                "Widget",
                "<html><head/><body><p>Quick Disconnect</p></body></html>",
                None,
            )
        )
        self.xv6State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv3.setText(QCoreApplication.translate("Widget", "XV-3", None))
        self.xv11.setText(QCoreApplication.translate("Widget", "XV-11", None))
        self.xv7State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv1State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv1.setText(QCoreApplication.translate("Widget", "XV-1", None))
        self.xv4State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv5State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.igniter.setText(QCoreApplication.translate("Widget", "Igniter", None))
        self.xv11State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.igniterState.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv6.setText(QCoreApplication.translate("Widget", "XV-6", None))
        self.xv12.setText(QCoreApplication.translate("Widget", "XV-12", None))
        self.quickDisconnectState.setText(
            QCoreApplication.translate("Widget", "CLOSED", None)
        )
        self.cv1.setText(QCoreApplication.translate("Widget", "Fire Valve", None))
        self.xv4.setText(QCoreApplication.translate("Widget", "XV-4", None))
        self.xv10State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv9State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv3State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv10.setText(QCoreApplication.translate("Widget", "XV-10", None))
        self.xv2State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.cv1State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv2.setText(QCoreApplication.translate("Widget", "XV-2", None))
        self.xv7.setText(QCoreApplication.translate("Widget", "XV-7", None))
        self.xv12State.setText(QCoreApplication.translate("Widget", "CLOSED", None))
        self.xv9.setText(QCoreApplication.translate("Widget", "XV-9", None))
        self.xv8.setText(QCoreApplication.translate("Widget", "XV-8", None))
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.telemetryTab),
            QCoreApplication.translate("Widget", "Telemetry", None),
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.pAndIdTab),
            QCoreApplication.translate("Widget", "P&&ID", None),
        )
